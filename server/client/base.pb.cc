...
namespace cs
{
constexpr test::test(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
{
}
struct testDefaultTypeInternal
{
    constexpr testDefaultTypeInternal() : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{})
    {
    }
...
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const **file_level_service_descriptors_base_2eproto =
    nullptr;
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::
    AddDescriptorsRunner dynamic_init_dummy_base_2eproto(&descriptor_table_base_2eproto);
namespace cs
{
...
test::test(::PROTOBUF_NAMESPACE_ID::Arena *arena, bool is_message_owned)
    : ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase(arena, is_message_owned)
{
    // @@protoc_insertion_point(arena_constructor:cs.test)
}
test::test(const test &from) : ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase()
{
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData *test::GetClassData() const
{
    return &_class_data_;
}
...
{
    return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_base_2eproto_getter,
                                                                &descriptor_table_base_2eproto_once,
