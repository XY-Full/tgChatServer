...
enum ErrorCode : int {
  ...
  Error_argument = 3,
  Error_muted = 130,
  Error_no_channel = 131,
  Error_msg_too_long = 132,
  Error_wrong_msg = 133,
  Error_no_msg = 134,
  Error_block_self = 135,
  Error_chat_in_cd = 136,
  Error_block_player_over_limit = 137,
  Error_item_num_limit = 138,
...
constexpr ErrorCode ErrorCode_MAX = Error_item_num_limit;
